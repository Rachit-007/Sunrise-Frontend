...
import useOpenMiniCart from "../../../talons/useOpenMiniCart";
import { getPrice } from "../../priceCalculator";
import Loader from "../../loader/index";
import { size } from "lodash";
import { Link } from "react-router-dom";

const OpenMiniCart = ({ setOpenMiniCart }) => {
  const { loading, removeCartItem, cartItems } = useOpenMiniCart();
                ...
                {cartItems && size(cartItems.lineItems) > 0 ? (
                  <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    <div className="flex justify-between">
                      ...
                      <div class="mt-6">
                        <Link
                          class="flex items-center justify-center rounded-md border border-transparent bg-green-600 px-14 py-3 text-base font-medium text-white shadow-sm hover:bg-green-700"
                          to="/cart"
                          onClick={() => setOpenMiniCart(false)}
                        >
                          Veiw Cart
