  ...
  return (
    <div className="relative">
      <Link to={`/product/${product.id}`}>
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow group  w-64 max-sm:w-80  ">
          <img
          ...
          <div className="px-5 pb-5">
            <h5 className="text-base font-bold h-10 tracking-tight text-gray-900 ">
              {product.name.en}
            </h5>
