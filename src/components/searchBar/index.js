    ...
    <>
      <div className="relative mr-10 max-sm:order-4 max-sm:mt-4 max-sm:w-full max-sm:mr-0">
        <form onSubmit={handleSubmit(onSearch)} className="flex items-center">
          ...
          <button
            type="submit"
            className="p-2 ml-2 text-sm font-medium text-white bg-green-700 rounded-lg border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 "
          >
            <svg
              className="w-5 h-5"
              fill="none"
