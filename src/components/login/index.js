...
const Login = () => {
  return (
    <>
      <div className="flex mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 max-w-md mt-28 max-sm:border-none max-sm:mt-40 max-sm:shadow-none border-2 p-3 ">
